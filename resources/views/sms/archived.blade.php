...
@include('partials.sms-nav')
  ...
  <tbody>
   ...
   <td>
    ...
    <a href="{{route('sms.relive', ['id'=>$sms_records->id])}}" class="w-1/6 hover:bg-green-300 bg-green-600 border-2 border-green-500 hover:border-green-500 bg-transparent text-white hover:text-green-600 py-1 px-2 font-semibold rounded-md"><i class="fas fa-box-open"></i></i> Make Live</a>
   </td>
   @endforeach
  </tbody>
</table>
