...
<form action="/sms/send" method="POST">
  @csrf
    ...
    <div class="flex-auto bg-gray-50 p-6 shadow-md rounded">
        ...
        <div class="flex m-2 space-x-4  text-center  flex-wrap content-evenly justify-center">
            <input type="number" class="w-2/6" id="number" name="number" aria-describedby="number" placeholder="Enter Number" value="{{ old('number') }}">
        </div>    
    ...
    <div class="flex-auto bg-gray-50 p-6 shadow-md rounded">
        <div class="flex m-2 space-x-4  text-center  flex-wrap content-evenly justify-center">
            <button type="submit" class="w-1/6 hover:bg-blue-600 bg-blue-300 border-2 border-blue-500 hover:border-blue-500 bg-transparent text-gray-800 hover:text-white py-3 px-4 font-semibold rounded-md"><i class="far fa-paper-plane"></i> Send</button>
        </div>
    </div>
