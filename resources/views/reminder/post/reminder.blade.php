...
@foreach($combined_data_due as $data)
        ...
        <p class="mt-2"> RE: Your {{$data->Make}} {{$data->Model}} {{$data->RegNo}}</p>
        <p class="mt-8">
        ...
        <p class="mt-2">
            Should you wish us to undertake the service and MoT please do not hesitate to contact David the Service Advisor, and he will be more than happy to book your car in for you.
        </p>
        <p class="mt-8">Your sincerely,</p>
...
@foreach($mot_data_due as $data)
        ...
        <div class="page-break"></div>
@endforeach
@foreach($service_data_due   as $data)
        ...
        <p class="mt-2">RE: Your {{$data->Make}} {{$data->Model}} {{$data->RegNo}}</p>
        <p class="mt-8">
            I would like to take this opportunity of reminding you that your service is due before the {{date('d/m/Y', strtotime($data->ServDueDate))}}
        </p>
        <p class="mt-2">
            Should you wish us to undertake the service please do not hesitate to contact David the Service Advisor, and he will be more than happy to book your car in for you.
        </p>
        <p class="mt-8">Your sincerely,</p>
        <p class="mt-2">David Evans, Service Advisor</p>
        <p class="mt-2">service@evosussex.co.uk</p>
